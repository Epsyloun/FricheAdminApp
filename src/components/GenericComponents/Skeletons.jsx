...
import { Container, Grid, Paper, Skeleton, Stack, Typography } from '@mui/material';
        ...
        <Paper sx={PaperAnimation}>
            <Grid container sx={StyledGrid}>
                ...
                <Grid mt={2} item xs={12} md={8} >
                    <Stack spacing={2} m={1}>
                        <Skeleton animation="wave" variant="rounded" width='100%' height='3.5em' />
                        <Skeleton animation="wave" variant="rounded" width='100%' height='3.5em' />
                        <Skeleton animation="wave" variant="rounded" width='100%' height='3.5em' />
                        <Skeleton animation="wave" variant="rounded" width='44em' height='0em' />
                    </Stack>
                </Grid>
...
function LoaderDeudas() {
    ...
    const StyledSkeletonFinalRectangular={marginBottom:'1em', marginRight:'1em'}
                ...
                <Grid item xs={12} md={4}>
                    <Paper>
                        <Stack width={'100%'} direction='row' >
                            <Skeleton sx={StyledSkeletonCircular} animation="wave" variant="circular" width={'3em'} height={'3em'}/>
                            <Skeleton sx={StyledSkeletonRectangular} animation="wave" variant="rectangular" width={'10em'} height={'1.5em'}/>
                        </Stack>
                        <Stack sx={StyledStack}>
                            <Skeleton animation="wave" variant="rectangular" width={'8em'} height={'3em'}/>
                        </Stack>
                        <Stack sx={StyledFinalStack}>
                            <Skeleton sx={StyledSkeletonCircular} animation="wave" variant="rectangular" width={'6em'} height={'1em'}/>
                        </Stack>
                    </Paper>
                </Grid>
                <Grid item xs={12} md={4}>
                    <Paper>
                        ...
                        <Stack sx={StyledFinalStack}>
                            <Skeleton sx={StyledSkeletonFinalRectangular} animation="wave" variant="rectangular" width={'6em'} height={'1em'}/>
                        </Stack>
                    </Paper>
                </Grid>
                <Grid item xs={12} md={4}>
    ...
    <Grid sx={StyledGrid}>
        <Grid container spacing={2}>
            <Grid item xs={12} md={3}>
                <Paper>
                    <Stack alignItems='center' spacing={2}>
                        <Skeleton sx={{marginTop:'20px'}} animation='wave' variant='rectangular' width={'40%'} height="1em"/>
                        <Skeleton animation='wave' variant='circular' width='6em' height="6em"/>
                        <Skeleton animation='wave' variant='rectangular' width={'40%'} height="2.5em"/>
                        <Skeleton animation='wave' variant='rectangular' width={'40%'} height="1em"/>
            ...
            <Grid item xs={12} md={6}>
                <Paper>
                    <Stack alignItems='center' spacing={2}>
                        <Skeleton sx={{marginTop:'3.4em'}} animation='wave' variant='rectangular' width={'40%'} height="2em"/>
                        <Skeleton animation='wave' variant='rectangular' width='75%' height="3.5em"/>
                        <Stack width={'75%'} alignItems="flex-end">
                            <Skeleton animation='wave' variant='rectangular' width={'25%'} height="2.5em"/>
                         </Stack>
                        <Skeleton animation='wave' variant='rectangular' height="3.35em"/>
                    </Stack>
                </Paper>
            </Grid>
            <Grid item xs={12} md={6}>
                <Paper >
                    <Stack alignItems='center' spacing={2}>
                        <Skeleton sx={{marginTop:'20px'}} animation='wave' variant='rectangular' width={'40%'} height="1em"/>
                        <Skeleton animation='wave' variant='circular' width='9em' height="9em"/>
                        <Skeleton animation='wave' variant='rectangular' width={'20%'} height="2.5em"/>
                        <Skeleton animation='wave' variant='rectangular' height="1em"/>
                    </Stack>
                </Paper>
            </Grid>
    ...
    <>
        <Grid container sx={StyledGrid}>
            ...
            <Stack mt={2} direction='row' width={'100%'} sx={StyledSecondStack}>
                <Skeleton animation='wave' variant="rectangular" width='5em' height={'3em'}/>
                <Skeleton animation='wave' variant="rectangular" width='5em' height={'3em'}/>
                <Skeleton animation='wave' variant="rectangular" width='5em' height={'3em'}/>
            </Stack>
        </Grid>
            ...
            <Paper sx={StyledPaper}>
                <Stack width='100%' sx={StyledStackItem}>
                    <Stack width='35%' sx={StyledStackInner}>
                        <Skeleton sx={StyledSkeletonHorizontal} animation="wave" variant="circular" width={100} height={100}/>
                    </Stack>
                    <Stack width='65%' sx={StyledStackInner} >
                        <Skeleton sx={StyledSkeletonFirst} animation="wave" variant="rectangular">
                        ...
                        <Skeleton sx={StyledSkeletonLast} animation="wave" variant="rectangular">
...
export {LoaderAjustes,LoaderDeudas,LoaderFinanzas,LoaderGraficos, LoaderHome,LoaderInventario,LoaderMobile,LoaderPedidos};